...
exports.createPages = async ({
  ...
  /* Post, Projects, and Research pages */
  allMdx.edges.forEach(({ node }) => {
    ...
    // Check path prefix of Post, Projects and Research
    if (
      frontmatter.path.indexOf(options.pages.posts) !== 0 &&
      frontmatter.path.indexOf(options.pages.research) !== 0 &&
      frontmatter.path.indexOf(options.pages.projects) !== 0
    ) {
    ...
    if (frontmatter.path.indexOf(options.pages.posts) === 0) {
      ...
      data.type = 'research';
    } else if (frontmatter.path.indexOf(options.pages.projects) === 0) {
      data.type = 'projects';
    }
    ...
    fields: {
      ...
      type: {
        ...
        resolve: (source) => {
          ...
          if (source.path.indexOf(options.pages.projects) === 0) {
            return 'projects';
          }
          return '';
        },
